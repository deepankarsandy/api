### Goal
- setup a new api app with bun and elysia framework. see https://elysiajs.com/
- use typescript
- setup formatting, linting and testing
- Setup CQRS pattern with clean architecture, create dirs
